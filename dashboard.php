...
$result = mysqli_query($mysqli, "SELECT * FROM pplg_db ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="images/icon/60111.jpg" alt="John Doe" />
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-12">
                            <div class="au-breadcrumb-content">
                                ...
                                <form class="au-form-icon--sm" action="" method="post">
                                    <input class="au-input--w300 au-input--style2" type="text" placeholder="Search for data XI - PPLG">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--green">
                                ...
                                <span class="desc">student available</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                ...
                                <span class="desc">student out</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                ...
                                <span class="desc">student downgrade</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--red">
                                <h2 class="number">Rp 400.000</h2>
                                <span class="desc">total kas money</span>
                                <div class="icon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="top-campaign">
                                <h3 class="title-3 m-b-30">top rankings</h3>
                            ...
                            <div class="table-data__tool">
                                ...
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                       <a href="add.php"><i class="zmdi zmdi-plus"></i>add<a/></button>
                                </div>
                            </div>
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <tbody>   
                                            ...
                                            echo "<td>".$user_data['collected']."</td>";
                                            echo "<td>".$user_data['os']."</td>";    
            ...
            <section class="p-t-60 p-b-20">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2018 Akmal Corp. All rights reserved. Supported by <a href="https://colorlib.com">Akmal Corp</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
